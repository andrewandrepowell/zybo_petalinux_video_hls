...
HD_PWD='/opt/Xilinx/Projects/zybo_petalinux_video_hls/zybo_petalinux_video_hls.runs/block_design_0_auto_us_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design_0_auto_us_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source block_design_0_auto_us_0.tcl
