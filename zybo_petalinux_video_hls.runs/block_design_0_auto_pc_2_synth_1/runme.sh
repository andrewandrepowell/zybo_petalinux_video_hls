...
HD_PWD='/opt/Xilinx/Projects/zybo_petalinux_video_hls/zybo_petalinux_video_hls.runs/block_design_0_auto_pc_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design_0_auto_pc_2.vds -m64 -mode batch -messageDb vivado.pb -notrace -source block_design_0_auto_pc_2.tcl
