...
HD_PWD='/opt/Xilinx/Projects/zybo_petalinux_video_hls/zybo_petalinux_video_hls.runs/block_design_0_axi_vdma_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design_0_axi_vdma_1_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source block_design_0_axi_vdma_1_1.tcl
