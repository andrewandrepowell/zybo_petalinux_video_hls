...
entity filt_Block_codeRepl42_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of filt_Block_codeRepl42_proc is 
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_continue)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not(ap_sig_58))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_sig_58)
    begin
        case ap_CS_fsm is
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_sig_cseq_ST_st1_fsm_0, ap_sig_58)
    begin
        if (((ap_const_logic_1 = ap_done_reg) or ((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not(ap_sig_58)))) then 
    ...
    ap_ready_assign_proc : process(ap_sig_cseq_ST_st1_fsm_0, ap_sig_58)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not(ap_sig_58))) then 
    ...
    ap_sig_58_assign_proc : process(ap_start, ap_done_reg, src_mat_rows_V_out_full_n, src_mat_cols_V_out_full_n, dst_mat_rows_V_out_full_n, dst_mat_cols_V_out_full_n)
    begin
                ap_sig_58 <= ((src_mat_rows_V_out_full_n = ap_const_logic_0) or (src_mat_cols_V_out_full_n = ap_const_logic_0) or (dst_mat_rows_V_out_full_n = ap_const_logic_0) or (dst_mat_cols_V_out_full_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    dst_mat_cols_V_out_write_assign_proc : process(ap_sig_cseq_ST_st1_fsm_0, ap_sig_58)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not(ap_sig_58))) then 
    ...
    dst_mat_rows_V_out_write_assign_proc : process(ap_sig_cseq_ST_st1_fsm_0, ap_sig_58)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not(ap_sig_58))) then 
    ...
    src_mat_cols_V_out_write_assign_proc : process(ap_sig_cseq_ST_st1_fsm_0, ap_sig_58)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not(ap_sig_58))) then 
    ...
    src_mat_rows_V_out_write_assign_proc : process(ap_sig_cseq_ST_st1_fsm_0, ap_sig_58)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not(ap_sig_58))) then 
