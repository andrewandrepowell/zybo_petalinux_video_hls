...
reg   [8:0] p_1_i_reg_121;
wire   [0:0] exitcond1_i_fu_132_p2;
reg    ap_sig_cseq_ST_st2_fsm_1;
reg    ap_sig_84;
wire   [7:0] i_V_fu_138_p2;
reg   [7:0] i_V_reg_160;
wire   [0:0] exitcond2_i_fu_144_p2;
reg    ap_sig_106;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(1'b0 == exitcond1_i_fu_132_p2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_106) & ~(1'b0 == exitcond2_i_fu_144_p2))) begin
            ap_reg_ppiten_pp0_it0 <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (1'b0 == exitcond1_i_fu_132_p2))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (1'b0 == exitcond1_i_fu_132_p2)) | ((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_106) & ~(1'b0 == exitcond2_i_fu_144_p2)))) begin
            ap_reg_ppiten_pp0_it1 <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & (1'b1 == ap_reg_ppiten_pp0_it0) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_106) & (1'b0 == exitcond2_i_fu_144_p2))) begin
...
always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(1'b0 == exitcond1_i_fu_132_p2)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(1'b0 == exitcond1_i_fu_132_p2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & (1'b1 == ap_reg_ppiten_pp0_it1) & (exitcond2_i_reg_165 == 1'b0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & (1'b1 == ap_reg_ppiten_pp0_it1) & (exitcond2_i_reg_165 == 1'b0) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_106))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_st2_fsm_1 : begin
            if (~(1'b0 == exitcond1_i_fu_132_p2)) begin
                ap_NS_fsm = ap_ST_st1_fsm_0;
            end else begin
        ...
        ap_ST_pp0_stg0_fsm_2 : begin
            if (~((1'b1 == ap_reg_ppiten_pp0_it0) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_106) & ~(1'b0 == exitcond2_i_fu_144_p2))) begin
                ap_NS_fsm = ap_ST_pp0_stg0_fsm_2;
            end else if (((1'b1 == ap_reg_ppiten_pp0_it0) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_106) & ~(1'b0 == exitcond2_i_fu_144_p2))) begin
...
always @ (*) begin
    ap_sig_106 = (((exitcond2_i_reg_165 == 1'b0) & (src_data_stream_0_V_empty_n == 1'b0)) | ((exitcond2_i_reg_165 == 1'b0) & (src_data_stream_1_V_empty_n == 1'b0)) | ((exitcond2_i_reg_165 == 1'b0) & (src_data_stream_2_V_empty_n == 1'b0)) | ((exitcond2_i_reg_165 == 1'b0) & (dst_data_stream_0_V_full_n == 1'b0)) | ((exitcond2_i_reg_165 == 1'b0) & (dst_data_stream_1_V_full_n == 1'b0)) | ((exitcond2_i_reg_165 == 1'b0) & (dst_data_stream_2_V_full_n == 1'b0)));
end
...
assign exitcond1_i_fu_132_p2 = ((p_i_reg_110 == ap_const_lv8_F0) ? 1'b1 : 1'b0);

assign exitcond2_i_fu_144_p2 = ((p_1_i_reg_121 == ap_const_lv9_140) ? 1'b1 : 1'b0);

assign i_V_fu_138_p2 = (p_i_reg_110 + ap_const_lv8_1);

assign j_V_fu_150_p2 = (p_1_i_reg_121 + ap_const_lv9_1);
