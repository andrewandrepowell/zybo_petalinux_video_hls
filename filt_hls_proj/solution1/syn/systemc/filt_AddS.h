...
#ifndef _filt_AddS_HH_
#define _filt_AddS_HH_
...
struct filt_AddS : public sc_module {
    ...
    // Module declarations
    filt_AddS(sc_module_name name);
    SC_HAS_PROCESS(filt_AddS);
    ...
    sc_signal< sc_lv<1> > exitcond2_i_reg_165;
    ...
    void thread_exitcond1_i_fu_132_p2();
    void thread_exitcond2_i_fu_144_p2();
