...
#ifndef _filt_Merge_240_320_0_6144_s_HH_
#define _filt_Merge_240_320_0_6144_s_HH_
...
struct filt_Merge_240_320_0_6144_s : public sc_module {
    ...
    sc_in< sc_lv<8> > src3_data_stream_V_dout;
    sc_in< sc_logic > src3_data_stream_V_empty_n;
    sc_out< sc_logic > src3_data_stream_V_read;
    ...
    // Module declarations
    filt_Merge_240_320_0_6144_s(sc_module_name name);
    SC_HAS_PROCESS(filt_Merge_240_320_0_6144_s);

    ~filt_Merge_240_320_0_6144_s();
    ...
    sc_signal< sc_lv<9> > p_1_reg_139;
    sc_signal< sc_lv<1> > exitcond2_fu_150_p2;
    sc_signal< sc_logic > ap_sig_cseq_ST_st2_fsm_1;
    sc_signal< bool > ap_sig_94;
    sc_signal< sc_lv<8> > i_V_fu_156_p2;
    sc_signal< sc_lv<8> > i_V_reg_178;
    sc_signal< sc_lv<1> > exitcond_fu_162_p2;
    sc_signal< bool > ap_sig_122;
    sc_signal< sc_lv<9> > j_V_fu_168_p2;
    sc_signal< sc_lv<8> > p_s_reg_128;
    ...
    void thread_exitcond2_fu_150_p2();
    void thread_exitcond_fu_162_p2();
    void thread_i_V_fu_156_p2();
    ...
    void thread_src3_data_stream_V_blk_n();
    void thread_src3_data_stream_V_read();
