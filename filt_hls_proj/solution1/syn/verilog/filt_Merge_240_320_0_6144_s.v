...
module filt_Merge_240_320_0_6144_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        src3_data_stream_V_dout,
        src3_data_stream_V_empty_n,
        src3_data_stream_V_read,
...
input  [7:0] src3_data_stream_V_dout;
input   src3_data_stream_V_empty_n;
output   src3_data_stream_V_read;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(1'b0 == exitcond2_fu_150_p2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_122) & ~(1'b0 == exitcond_fu_162_p2))) begin
            ap_reg_ppiten_pp0_it0 <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (1'b0 == exitcond2_fu_150_p2))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (1'b0 == exitcond2_fu_150_p2)) | ((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_122) & ~(1'b0 == exitcond_fu_162_p2)))) begin
            ap_reg_ppiten_pp0_it1 <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & (1'b1 == ap_reg_ppiten_pp0_it0) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_122) & (1'b0 == exitcond_fu_162_p2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~ap_sig_150)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_122))) begin
...
always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(1'b0 == exitcond2_fu_150_p2)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(1'b0 == exitcond2_fu_150_p2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & (1'b1 == ap_reg_ppiten_pp0_it1) & (exitcond_reg_183 == 1'b0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & (1'b1 == ap_reg_ppiten_pp0_it1) & (exitcond_reg_183 == 1'b0) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_122))) begin
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & (1'b1 == ap_reg_ppiten_pp0_it1) & (exitcond_reg_183 == 1'b0))) begin
        ...
        src3_data_stream_V_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & (1'b1 == ap_reg_ppiten_pp0_it1) & (exitcond_reg_183 == 1'b0) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_122))) begin
        src3_data_stream_V_read = 1'b1;
    end else begin
        src3_data_stream_V_read = 1'b0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_st2_fsm_1 : begin
            if (~(1'b0 == exitcond2_fu_150_p2)) begin
                ap_NS_fsm = ap_ST_st1_fsm_0;
            end else begin
        ...
        ap_ST_pp0_stg0_fsm_2 : begin
            if (~((1'b1 == ap_reg_ppiten_pp0_it0) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_122) & ~(1'b0 == exitcond_fu_162_p2))) begin
                ap_NS_fsm = ap_ST_pp0_stg0_fsm_2;
            end else if (((1'b1 == ap_reg_ppiten_pp0_it0) & ~((1'b1 == ap_reg_ppiten_pp0_it1) & ap_sig_122) & ~(1'b0 == exitcond_fu_162_p2))) begin
...
always @ (*) begin
    ap_sig_122 = (((exitcond_reg_183 == 1'b0) & (src0_data_stream_V_empty_n == 1'b0)) | ((exitcond_reg_183 == 1'b0) & (src1_data_stream_V_empty_n == 1'b0)) | ((exitcond_reg_183 == 1'b0) & (src2_data_stream_V_empty_n == 1'b0)) | ((exitcond_reg_183 == 1'b0) & (src3_data_stream_V_empty_n == 1'b0)) | ((exitcond_reg_183 == 1'b0) & (dst_data_stream_0_V_full_n == 1'b0)) | ((exitcond_reg_183 == 1'b0) & (dst_data_stream_1_V_full_n == 1'b0)) | ((exitcond_reg_183 == 1'b0) & (dst_data_stream_2_V_full_n == 1'b0)) | ((exitcond_reg_183 == 1'b0) & (dst_data_stream_3_V_full_n == 1'b0)));
end
...
assign dst_data_stream_3_V_din = src3_data_stream_V_dout;

assign exitcond2_fu_150_p2 = ((p_s_reg_128 == ap_const_lv8_F0) ? 1'b1 : 1'b0);

assign exitcond_fu_162_p2 = ((p_1_reg_139 == ap_const_lv9_140) ? 1'b1 : 1'b0);

assign i_V_fu_156_p2 = (p_s_reg_128 + ap_const_lv8_1);

assign j_V_fu_168_p2 = (p_1_reg_139 + ap_const_lv9_1);

endmodule //filt_Merge_240_320_0_6144_s
