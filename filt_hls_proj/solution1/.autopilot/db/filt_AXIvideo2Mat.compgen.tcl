...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { src_axi_TDATA { I 32 vector } src_axi_TVALID { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { src_axi_TREADY { O 1 bit } src_axi_TDEST { I 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_rows_V_dout { I 9 vector } img_rows_V_empty_n { I 1 bit } img_rows_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_data_stream_3_V_din { O 8 vector } img_data_stream_3_V_full_n { I 1 bit } img_data_stream_3_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_rows_V_out_din { O 9 vector } img_rows_V_out_full_n { I 1 bit } img_rows_V_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_cols_V_out_din { O 10 vector } img_cols_V_out_full_n { I 1 bit } img_cols_V_out_write { O 1 bit } } \
} "
}
