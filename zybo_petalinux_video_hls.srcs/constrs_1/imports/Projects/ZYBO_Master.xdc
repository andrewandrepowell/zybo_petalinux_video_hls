...
#create_generated_clock -name pixel_clk_0 -source [get_pins {block_design_0_i/axi_dispctrl_0_PXL_CLK_O}]
set_false_path -from [get_clocks clk_fpga_0] -to [get_clocks I]
set_false_path -from [get_clocks I] -to [get_clocks clk_fpga_0]
